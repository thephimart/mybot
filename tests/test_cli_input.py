...
from mybot.cli import commands
...
def mock_prompt_session():
    ...
    with patch("mybot.cli.commands._PROMPT_SESSION", mock_session), \
         patch("mybot.cli.commands.patch_stdout"):
        yield mock_session
...
def test_init_prompt_session_creates_session():
    ...
    with patch("mybot.cli.commands.PromptSession") as MockSession, \
         patch("mybot.cli.commands.FileHistory") as MockHistory, \
